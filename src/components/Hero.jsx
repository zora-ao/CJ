...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="flex flex-wrap md:h-screen justify-center md:justify-evenly items-center scroll-mt-40 mt-20 md:mt-0 px-4 bg-white dark:bg-neutral-950 transition-colors duration-300"
    >
      {/* Text Section */}
